...
const dict = {
  tr: {
    ...
    hero_status: "SİSTEM AKTİF &nbsp;—&nbsp; KARABÜK ÜNİVERSİTESİ",
    hero_desc: "Devreleri anlayan, kod yazan, sistemleri birbirine bağlayan biri. Donanım ve yazılımın kesiştiği yerde çalışmak benim için hem meslek hem içgüdü.",
    ...
    about_p2: "Anadilim Türkçe, iyi İngilizce bilirim, Almancayı öğrenme aşamasındayım. Linux, SolidWorks, C ve Python odaklı çalışıyorum. PCB tasarımı (KiCad), Arduino, Raspberry Pi, gömülü C programlama ve Telegram bot geliştirme temel çalışma alanlarım.",
